...
| **`module-5/`** | PR-review exercise. `spec.md`, `pr-description.md`, and `proposed/` — find where the proposed change diverges from the spec. | Module 5, hands-on. See `module-5/README.md` for the exercise framing. |
